...
import 'package:animated_card_stack_finance/core/constants/default_constant.dart';
...
extension WidgetExtension on Widget {
  Center center() => Center(child: this);
   ...
   Widget addDividerBelow({double thickness = 1}) {
    return Column(
      children: [this, Divider(thickness: thickness)],
    );
  }
